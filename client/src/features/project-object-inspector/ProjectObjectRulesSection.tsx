...
const ruleActionButtonClass =
  "inline-flex h-6 items-center gap-1 rounded border border-slate-200 bg-white px-1.5 text-[11px] font-medium leading-none text-slate-600 outline-none transition-colors hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700 focus-visible:ring-2 focus-visible:ring-sky-100";
const ruleIconButtonClass =
  "inline-flex h-6 w-6 items-center justify-center rounded border border-slate-200 bg-white text-slate-500 outline-none transition-colors hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700 focus-visible:ring-2 focus-visible:ring-sky-100";
const ruleAddIconButtonClass =
  "inline-flex h-7 w-7 items-center justify-center rounded-md border border-sky-200 bg-sky-50 text-sky-700 outline-none transition-colors hover:border-sky-300 hover:bg-sky-100 hover:text-sky-800 focus-visible:ring-2 focus-visible:ring-sky-100";
const ruleDangerIconButtonClass =
  "inline-flex h-6 w-6 items-center justify-center rounded border border-red-100 bg-white text-red-500 outline-none transition-colors hover:border-red-200 hover:bg-red-50 hover:text-red-700 focus-visible:ring-2 focus-visible:ring-red-100";
const ruleWideActionButtonClass =
  "inline-flex h-7 items-center justify-center gap-1 rounded-md border border-slate-200 bg-white px-2 text-[11px] font-medium leading-none text-slate-600 outline-none transition-colors hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700 focus-visible:ring-2 focus-visible:ring-sky-100";
const ruleSelectClass =
  "h-8 min-w-0 rounded-md border border-slate-200 bg-white px-2 text-xs font-semibold text-slate-700 outline-none transition-colors focus:border-sky-500 focus:ring-2 focus:ring-sky-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400";
const ruleInlineSelectClass =
  "h-7 min-w-0 rounded-md border border-slate-200 bg-white px-2 text-[12px] font-medium text-slate-800 outline-none transition-colors focus:border-sky-400 focus:ring-2 focus:ring-sky-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400";
const ruleInlineInputClass =
  "h-7 min-w-0 rounded-md border border-slate-200 bg-white px-2 text-[12px] font-medium tabular-nums text-slate-900 outline-none transition-colors focus:border-sky-400 focus:ring-2 focus:ring-sky-100";
const ruleRowRemoveButtonClass =
...
const ruleLabelInputClass =
  "h-8 min-w-0 flex-1 rounded-md border border-slate-200 bg-white px-2 text-xs font-semibold text-slate-800 outline-none transition-colors focus:border-sky-500 focus:ring-2 focus:ring-sky-100";
    ...
    >
      {inherited ? (
        <div className="flex items-center justify-between gap-2 rounded-md border border-slate-200 bg-slate-50 px-2 py-1.5 text-xs text-slate-600">
          ...
          <button className={ruleActionButtonClass} type="button" onClick={onCustomize}>
            Customize
          </button>
        </div>
      ) : null}
      {playCards.length ? (
        <div className={cx("space-y-2", inherited ? "pointer-events-none opacity-70" : "")}>
          {playCards.map((playCard) => (
            <div key={playCard.id} className="rounded-md border border-slate-200 bg-slate-50 p-2">
              <div className="flex items-center gap-1.5">
                <input
                  aria-label="Rule label"
                  className={ruleLabelInputClass}
          ...
          {!inherited ? (
            <div className="flex justify-center">
              <button
                aria-label="Add rule"
                className={ruleAddIconButtonClass}
                title="Add rule"
                type="button"
        ...
        <div className="flex items-center justify-between gap-2 rounded-md border border-dashed border-slate-200 bg-slate-50 px-2 py-2 text-xs text-slate-500">
          <span>No play rules yet.</span>
          {!inherited ? (
            <button className={ruleActionButtonClass} type="button" onClick={onAddPlayCard}>
              <Plus size={12} />
              Add rule
            </button>
          ) : null}
...
function RulePlayCardActions({
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <button
        className={ruleDangerIconButtonClass}
        title={removeTitle}
        type="button"
        onClick={onRemove}
      >
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-start gap-2">
        <RuleSubsectionLabel info="Add what must be true before the card can be played. With no conditions, the card can always be played.">
          Play if
        </RuleSubsectionLabel>
      </div>
      {conditions.length ? (
        ...
        <div className="rounded-md border border-dashed border-slate-200 bg-slate-50 p-2">
          ...
          <button
            className={ruleWideActionButtonClass}
            type="button"
...
function RuleConditionRow({
  ...
  return (
    <div className="group flex overflow-hidden rounded-md border border-slate-200 bg-white text-[13px]">
      <div className="flex w-28 shrink-0 items-center px-2 py-2">{conditionTypeSelect}</div>
        ...
        {condition.type === "counter" ? (
          <>
            <div className="flex flex-wrap items-center gap-1">
              <select
                aria-label="Counter"
                className={cx(ruleInlineSelectClass, "min-w-28 flex-1")}
              ...
              <select
                ...
                className={cx(ruleInlineSelectClass, "w-24")}
              ...
              <input
                ...
                className={cx(ruleInlineInputClass, "w-16")}
                type="number"
      ...
      <button
        className={ruleRowRemoveButtonClass}
...
function RuleEffectsEditor({
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-start gap-2">
        <RuleSubsectionLabel info="Add what happens after the card is played. Effects happen from top to bottom.">
          Then
        </RuleSubsectionLabel>
      </div>
      {effects.length ? (
        ...
        <p className="rounded-md border border-dashed border-slate-200 bg-slate-50 px-2 py-2 text-xs text-slate-500">
          No effects. Playing the card will not change anything.
        </p>
      )}
      <button
        className={ruleWideActionButtonClass}
...
function RuleEffectRow({
  ...
  return (
    <div className="group flex overflow-hidden rounded-md border border-slate-200 bg-white text-[13px]">
      <div className="flex w-28 shrink-0 items-center px-2 py-2">{effectTypeSelect}</div>
        ...
        {effect.type === "modifyCounter" ? (
          ...
          <div className="flex flex-wrap items-center gap-1">
            ...
            <select
              ...
              className={cx(ruleInlineSelectClass, "min-w-24 flex-1")}
              value={effect.side}
              onChange={(event) =>
                onChange({
                  ...effect,
          ...
          <div className="flex flex-wrap items-center gap-1">
            ...
            <input
              ...
              className={cx(ruleInlineInputClass, "w-14")}
              type="number"
              value={effect.count}
              onChange={(event) =>
...
function RoleSelect({
  ...
  return (
    <select
      aria-label={ariaLabel}
      className={cx(inline ? ruleInlineSelectClass : ruleSelectClass, className)}
      value={value}
...
function RuleNotice({ children }: { children: ReactNode }) {
  return (
